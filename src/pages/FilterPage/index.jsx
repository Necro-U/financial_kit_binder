...
const AnalysisPage = () => {
  ...
  const { stocks: rows } = useSelector((state) => state.stocks);
    ...
    try {
      ...
      if (marketCap) {
        if (marketCap === "200B") query.market_cap_min = "200000000";
          ...
          query.market_cap_max = "200000000";
          query.market_cap_min = "10000000";
      ...
      if (peRatio) {
        ...
        else if (peRatio === "25-50") {
          query.pe_ratio_max = "50";
          query.pe_ratio_min = "25";
        } else if (peRatio === "15-25") {
          query.pe_ratio_max = "25";
          query.pe_ratio_min = "15";
